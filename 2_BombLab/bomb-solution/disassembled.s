...
0000000000400da0 <main>:
  ...
  // After initialize_bomb, read_line is called.
  400e1e:	bf 38 23 40 00       	mov    $0x402338,%edi
  400e23:	e8 e8 fc ff ff       	callq  400b10 <puts@plt>
  400e28:	bf 78 23 40 00       	mov    $0x402378,%edi
  400e2d:	e8 de fc ff ff       	callq  400b10 <puts@plt>

  // return value from read_line, %rdi, would be passed as the first argument to phase_1
  ...
  // Before entering phase_2, read line again, store result in %rdi
  // Then enter phase_2
  ...
  // Before entering phase_3, read line again, store the result in $rdi
...
0000000000400efc <phase_2>:
  // %rdi stores the latest input line

  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx

  // 0x28 = 40, 5 bytes. Allocate 5 new bytes on the stack.
  400efe:	48 83 ec 28          	sub    $0x28,%rsp

  // Store the pointer to the top of the stack to %rsi
  400f02:	48 89 e6             	mov    %rsp,%rsi

  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)
  400f0e:	74 20                	je     400f30 <phase_2+0x34>   // If 1, go to C
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>

  // B
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax          // %eax = (%rbx - 0.5 byte)
  400f1a:	01 c0                	add    %eax,%eax                // %eax = %eax + %eax
  400f1c:	39 03                	cmp    %eax,(%rbx)              // (%rbx) - %eax
  400f1e:	74 05                	je     400f25 <phase_2+0x29>    // If 0, go to A
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>    

  // A
  400f25:	48 83 c3 04          	add    $0x4,%rbx                // %rbx = %rbx + 0.5 byte
  400f29:	48 39 eb             	cmp    %rbp,%rbx                // %rbx - %rbp  // Comparing the address!!!
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>    // If not 0, go to B
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>

  // C
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx           // %rbx = %rsp + 0.5 byte
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp          // %rbp = %rsp + 3 bytes
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>    // go to B
...
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp                   // %rsp -= 3 bytes
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx               // %rcx = %rsp + 1.5 byte
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx               // %rdx = $rsp + 1 byte
  ...
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> // call sscanf
                                                                        // $rdi is the result from readline
                                                                        // %rsi is the pointer to the format string
                                                                        // %rdx, %rcx are the pointer to the 
                                                                        // address the input int would be stored.
                                                                        // Suppose the 1st input is i, 2nd input is j
                                                                        // %rdx = &i;
                                                                        // %rcx = &j;
  400f60:	83 f8 01             	cmp    $0x1,%eax                    // compute %eax - 1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>        // If %eax > 1, goto A
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>

  // A
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)               // compute (%rsp + 1 byte) - 7 == i - 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>        // If unsigned above, then go to B
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax               // %eax = (%rsp + 1 byte) = i
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)           // For jmpq: 
                                                                        // https://stackoverflow.com/q/26543029
                                                                        // https://stackoverflow.com/a/50978155
                                                                        // https://stackoverflow.com/a/9224054/9057530
                                                                        // Jump to address stored at location: 0x402470 + i * 8 
                                                                        // Using "x": http://visualgdb.com/gdbreference/commands/x
                                                                        // "x/8gx 0x402470" gives: 
  ...
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>        // goto C
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax                  // %eax = 707
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>        // goto C
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax                  // %eax = 256
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>        // goto C
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax                  // %eax = 389
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>        // goto C
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax                   // %eax = 206
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>        // goto C
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax                  // %eax = 682
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>        // goto C
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax                  // %eax = 327
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>        // goto C
  ...
  // C
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax               // compute %eax - j
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>        // if equal, go to D
                                                                        // One possible solution is: "0 207"
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>

  // D
  400fc9:	48 83 c4 18          	add    $0x18,%rsp                   // 0x400fc9 = 4198345
  400fcd:	c3                   	retq   

0000000000400fce <func4>:                                               // Consider i = 3
                                                                        // 1st arg, %rdi: i
                                                                        // 2nd arg, %rsi: 0
                                                                        // 3rd arg, %rdx: 14
  400fce:	48 83 ec 08          	sub    $0x8,%rsp                    // %rsp -= 1 byte
  400fd2:	89 d0                	mov    %edx,%eax                    // %rax = %rdx = 14
  400fd4:	29 f0                	sub    %esi,%eax                    // %rax -= %rsi, i.e., %rax -= 0
  400fd6:	89 c1                	mov    %eax,%ecx                    // %rcx = %rax = 14
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                   // %rcx >> = 31 (unsigned), the result is the sign bit, i.e., %rcx = 0
  400fdb:	01 c8                	add    %ecx,%eax                    // %rax += %rcx, i.e., nothing
  400fdd:	d1 f8                	sar    %eax                         // Shorthand for "sar %eax,1". %rax >> = 1 (signed).
                                                                        // As %rax > 0, equivalent to divide by 2. %rax = 7.
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx           // %rcx = %rax + %rsi = 7 + 0 = 7
  400fe2:	39 f9                	cmp    %edi,%ecx                    // compute %rcx - %rdi, i.e., 7 - i

  // B
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>          // If %rcx <= %rdi (signed comparison), goto A

  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx              // %rdx = %rcx - 1 = 7 - 1 = 6
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>               // Call fun4 again.
                                                                        // 1st arg, %rdi: i
                                                                        // 2nd arg, %rsi: 0
                                                                        // 3rd arg, %rdx: 6
                                                                        // Register values before executing B:
                                                                        // %rax = 3
                                                                        // %rsi = 0
                                                                        // %rcx = 3
  ...
  400ff7:	39 f9                	cmp    %edi,%ecx                    // compute %rcx - $rdi = 3 - 3 = 0
  400ff9:	7d 0c                	jge    401007 <func4+0x39>          // If %rcx >= %rdi, goto C
                                                                        // Now %rax is 3
...
000000000040100c <phase_4>:
                                                                        // Pointer to the input line is stored in %rdi
  40100c:	48 83 ec 18          	sub    $0x18,%rsp                   // %rsp -= 3 bytes
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx               // %rcx = %rsp + 1.5 byte
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx               // %rdx = %rsp + 1 byte
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi               // %esi = 0x4025cf
                                                                        // "x/s $rsi" gives "%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax                    // %rax = 0
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt> // 1st arg, %rdi: pointer to input line
                                                                        // 2nd arg, %rsi: pointer to format string 
                                                                        // 3rd arg, %rdx: pointer to address to store 1st int, call it i
                                                                        // 4rd arg, %rcx: pointer to address to store 2nd int, call it j
  401029:	83 f8 02             	cmp    $0x2,%eax                    // compute %rax - 2
  40102c:	75 07                	jne    401035 <phase_4+0x29>        // If not equal, goto A
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)               // compute (%rsp + 1 byte) - 12, i.e., i - 12
  401033:	76 05                	jbe    40103a <phase_4+0x2e>        // If below or equal, go to B
  ...
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                    // %rsi = 0x0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi               // %rdi = (%rsp + 1 byte) = (%rdx) = i
  401048:	e8 81 ff ff ff       	callq  400fce <func4>               // 1st arg, %rdi: i (suppose i = 3)
                                                                        // 2nd arg, %rsi: 0
                                                                        // 3rd arg, %rdx: 14
                                                                        // i = 0, return value 0
                                                                        // i = 1, return value 0
  ...
  40104d:	85 c0                	test   %eax,%eax                    // Check %rax is 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>        // If %rax is not 0, goto D
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)               // Compute (%rsp + 1.5 byte) - 0 = (%rcx) - 0 = j - 0 = j
  401056:	74 05                	je     40105d <phase_4+0x51>        // If equal, go to E
...
0000000000401062 <phase_5>:
                                                                    // %rdi stores the pointer to input string
                                                                    // Consider input "123456"
  401062:	53                   	push   %rbx                         
  ...
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                // %rax = %fs:0x28. 
                                                                    // Segement:offset notation: https://thestarman.pcministry.com/asm/debug/Segments.html
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)              // (%rsp + 3 byte) = %rax = %fs:0x28
  401078:	31 c0                	xor    %eax,%eax                    // %eax ^= %eax, i.e. %eax = 0.
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>       
  40107f:	83 f8 06             	cmp    $0x6,%eax                    // compute %eax - 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>        // If %eax == 6, goto A
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>

  // B                                                                  
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx           // 1.
                                                                    // "movzbl": move with zero-extend from byte to longword
                                                                    // "movsbl": move with sign-extend from byte to longword
                                                                    // 2. 
                                                                    // For historical issue, "word" refers to 16-bit: 2 bytes.
                                                                    // This is actually the legacy from the time when the address
                                                                    // is represented by 16-bit. Thus, longword means 32 bits and
                                                                    // quadword means 64 bits.
                                                                    // https://en.wikipedia.org/wiki/Word_(computer_architecture)
                                                                    // In assembly code command, "l" usually means "longword", i.e., 32-bit.

                                                                    // Before executing this line:
                                                                    // %rbx stores the pointer/address to the 1st char in the input line
                                                                    // "x %rbx" gives the ASCII code of the 1st character
                                                                    // "x/s $rbx" gives the entire input line
                                                                    // "x/s $rbx+1" omits the 1st character in the line
                                                                    // (%rbx + %rax) = (%rbx)
                                                                    // movzbl: take one byte(!), zero pad it in the front, and store to
                                                                    // the sepcified location.
                                                                    // Here, stores the 1st byte(char) of the input line to %rcx,
                                                                    // with essentially only one byte useful.
                                                                    // "print /c %rcx" gives '1' 
                                                                    // "print/c $cl" gives '1'

  40108f:	88 0c 24             	mov    %cl,(%rsp)                   // Move the lowest byte to (%rsp), the top of the stack
                                                                    // "x/c $rsp" gives "0x7ffffffedd50: 49 '1'"
                                                                    // %rsp stores the pointer to the top of the stack.
                                                                    // (%rsp) is a byte, the 1st char of the input

  401092:	48 8b 14 24          	mov    (%rsp),%rdx                  // Move top of the stack(the 1st char) to %rdx
                                                                    // (%rsp) is one byte, while %rdx is a register with 64 bits
  
  401096:	83 e2 0f             	and    $0xf,%edx                    // %edx &= 0xf, take the lowest 4 bits of %rdx, which is the lowest
                                                                    // 4 bits of the 1st char in the input line

  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx          // %edx = (0x4024b0 + %rdx), choose byte according to the last byte of each input character
                                                                    // The table is located at 0x4024b0.
                                                                    // (gdb) x/16bx 0x4024b0
                                                                    ...
                                                                    // 
                                                                    // We need "flyers"
                                                                    // So the offset is: 9, 15, 14, 5, 6, 7
                                                                    // Or:           0x: 9,  f,  e, 5, 6, 7
                                                                    // 0x1a = ')'
                                                                    // 0x1f = '/'
                                                                    // 0x1e = '.'
  ...
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)        // Problem: the memory location seems to be wrong? Not filling the 6 bytes starting from location %rsp + 2 byte.
                                                                    // But actually filling in sequence: %rsp + 0x10, %rsp + 0x11, %rsp + 0x12, ..., %rsp + 0x15.
                                                                    // Move the lowest byte of %rdx into (%rsp+%rax + 0x10)
  4010a4:	48 83 c0 01          	add    $0x1,%rax                    // %rax += 1
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                    // compute %rax - 6
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>        // If not euqal, goto B
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)              // "movb" means to move to byte. "movl" means mov to long. (%rsp + 2.75 byte) = 0
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi               // %dsi = 0x40245e
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi              // %rdi = %rsp + 2 byte
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>        // If 2 strings are equal, goto C
  ...
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>        // goto B

  // C                                                              // Actually you do not need to do anything for C, it passes automatically.
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax              // %rax = (%rsp + 3 byte)
...
00000000004010f4 <phase_6>:
  // You can be sure that %rsp always points to the top of the stack. This is the convention
  // that everyone should follow, including this lab.

  0x00000000004010f4 <+0>:     push   %r14                      // %rdi stores the pointer to input
  0x00000000004010f6 <+2>:     push   %r13
  0x00000000004010f8 <+4>:     push   %r12
  0x00000000004010fa <+6>:     push   %rbp
  0x00000000004010fb <+7>:     push   %rbx

  // <+23>~<+93> ensures no duplicate in the input number. 
  // Two indexing variable are used to traverse the input.
  0x00000000004010fc <+8>:     sub    $0x50,%rsp                // Allocate 10 bytes
  ...
  0x000000000040110e <+26>:    mov    $0x0,%r12d                // %r12d = 0. %r12d is the lower 4 bytes of the %r12.
  ...
  0x000000000040111b <+39>:    sub    $0x1,%eax                 // %eax -= 1
                                                                // %eax would store the value pointed by %r13, and %r13 would
                                                                // traversing through the address of all 6 input values. In this 
                                                                // step, you subtract 1 from this number, call it i. 
                                                                // If i <= 0,
                                                                // then subtracting 1 from it result in negative value. The bits 
                  IMPORTATNT =>                                 // in 2's complement representation would be a very large number
                                                                // when intepreted as unsigned. 
                                                                // If i > 6,
                                                                // then subtracing 1 from it would still be larger than 5.
                                                                // At <+45>, jbe, which is for unsigned number, is used 
                                                                // to determine whether the bomb explode or not. So this means that
                                                                // each input must be in the range [1, 6].
                                                                // As indicated earlier, <+23>~<+93> ensures no duplicate in the input number,
                                                                // the input have to be a permutation of {1,2,3,4,5,6}. !!!!!
  0x000000000040111e <+42>:    cmp    $0x5,%eax                 // comp %eax - 5.
  0x0000000000401121 <+45>:    jbe    0x401128 <phase_6+52>     // If %eax <= 5, goto <+52>=> i1 <= 6
                                                                // Here is using unsigned comparison, for simplicity,
                                                                // better input only non-negative value
  0x0000000000401123 <+47>:    callq  0x40143a <explode_bomb>
  0x0000000000401128 <+52>:    add    $0x1,%r12d                // %r12d += 1, i.e., %r12 == 1
  0x000000000040112c <+56>:    cmp    $0x6,%r12d                // Compute %r12d - 6
  0x0000000000401130 <+60>:    je     0x401153 <phase_6+95>     // If %r12d == 6, goto <+95>
  0x0000000000401132 <+62>:    mov    %r12d,%ebx                // %ebx = %r12d
  0x0000000000401135 <+65>:    movslq %ebx,%rax                 // move, with sign-extend, longword to quadword
                                                                // i.e., move from 32-bit to 64-bit.
                                                                // %rax = %ebx = %r12d, signed

  0x0000000000401138 <+68>:    mov    (%rsp,%rax,4),%eax        // %eax = (%rsp + 4 * %rax)
  0x000000000040113b <+71>:    cmp    %eax,0x0(%rbp)            // compute (%rbp) - %eax
  0x000000000040113e <+74>:    jne    0x401145 <phase_6+81>     // If not equal, goto <+81>
  0x0000000000401140 <+76>:    callq  0x40143a <explode_bomb>
  0x0000000000401145 <+81>:    add    $0x1,%ebx                 // %ebx += 1
  0x0000000000401148 <+84>:    cmp    $0x5,%ebx                 // compute %ebx - 5
  0x000000000040114b <+87>:    jle    0x401135 <phase_6+65>     // If %ebx <= 5, goto <+65>
  0x000000000040114d <+89>:    add    $0x4,%r13                 // %r13 += 4. %r13 originally points to stack top, now i2
  0x0000000000401151 <+93>:    jmp    0x401114 <phase_6+32>     // jump


  // <+95>~<+121> makes i1 = 7 - i1, i2 = 7 - i2, ... 
  0x0000000000401153 <+95>:    lea    0x18(%rsp),%rsi           // %rsi = %rsp + 3 byte
  ...
  0x0000000000401162 <+110>:   sub    (%rax),%edx               // %edx -= (%rax), i.e., %edx -= i1 = 7 - i1
  0x0000000000401164 <+112>:   mov    %edx,(%rax)               // %(rax) = %edx, i.e., i1 = 7 - i1
  0x0000000000401166 <+114>:   add    $0x4,%rax                 // %rax += 4, points to i2
  0x000000000040116a <+118>:   cmp    %rsi,%rax                 // compute %rax - %rsi, comparing ADDRESSES!!!
  0x000000000040116d <+121>:   jne    0x401160 <phase_6+108>    // If not equal, goto <+108>


  // http://zpalexander.com/binary-bomb-lab-phase-6/
  // <+123>~<+181>: store the pointers to each node onto the stack, according to the order specified by the 
  // processed input, "processed" means that each i is altered to be "7 - i" previously.  
  // The "size" specifier in the "x" command means number of bytes in each element displayed.
  // "b" means one byte, "h" means half-word(16-bit), "w" means word(32-bit), "g" means giant word(64-bit).
  ...
  // This looks like a linked list. Suppose each element is 32 bits.  
  // The 2nd element seems to denote the position of the node in the list.
  // The 3rd element seems to be the pointer to the next node. 0x00000000 is the null pointer.
  // The 4th element seems to be the padding to ensure alignment.
  ...
  0x0000000000401176 <+130>:   mov    0x8(%rdx),%rdx            // %rdx = (%rdx + 0x8)
                                                                // The size of src and dst always matches. As each register
                                                                // has 64 bits, 64-bit is taken from 0x8(%rdx).

  0x000000000040117a <+134>:   add    $0x1,%eax                 // %rax += 1
  0x000000000040117d <+137>:   cmp    %ecx,%eax                 // compute %rax - %rcx
  0x000000000040117f <+139>:   jne    0x401176 <phase_6+130>    // If %rax != %rcx, goto <+130>
  0x0000000000401181 <+141>:   jmp    0x401188 <phase_6+148>    // jump to <+148>

  0x0000000000401183 <+143>:   mov    $0x6032d0,%edx            // %rdx = 0x6032d0             
  0x0000000000401188 <+148>:   mov    %rdx,0x20(%rsp,%rsi,2)    // (%rsp + 0x20 + 2 * %rsi) = %rdx
  0x000000000040118d <+153>:   add    $0x4,%rsi                 // %rsi += 4
  0x0000000000401191 <+157>:   cmp    $0x18,%rsi                // compute %rsi - 0x18
  0x0000000000401195 <+161>:   je     0x4011ab <phase_6+183>    // If %rsi == 0x18, goto <+183>

  0x0000000000401197 <+163>:   mov    (%rsp,%rsi,1),%ecx        // %rcx = (%rsp + rsi)
  0x000000000040119a <+166>:   cmp    $0x1,%ecx                 // compute %rcx - 1
  ...
  // <+183>~<+220>:
  // Previous code(<+123>~<+181>) copies pointers to nodes to the stack according to the input.
  // Now change the pointer in the linked list.
  // The pointer (like the node* next; variable) in each node is changed, to match the order
  // of the address stored on the stack. So the list is reordered.

  // To be specific, suppose the stack is shown below.
  -----------
  | addr6   |
  -----------
  | addr5   |
  ...
  | ints    | <- %rsp
  -----------
  // To be specific, the node at addr1, would have its pointer changed to be addr2.
  // In other words, in C: addr1->next = addr2; where addr1 has type (node*).
  // For example, the pointer stored by the node at address %rsp + 0x20 would be %rsp + 0x28

  (gdb) x/24wx 0x006032d0
  // Here each line represents 16 bytes, each element represents 4 bytes.
  0x6032d0 <node1>:       0x0000014c      0x00000001      0x006032e0      0x00000000
  0x6032e0 <node2>:       0x000000a8      0x00000002      0x006032f0      0x00000000
  0x6032f0 <node3>:       0x0000039c      0x00000003      0x00603300      0x00000000
  0x603300 <node4>:       0x000002b3      0x00000004      0x00603310      0x00000000
  ...
  0x603320 <node6>:       0x000001bb      0x00000006      0x00000000      0x00000000
                        ------------------------------------------------------------
                        | value       | position      | pointer to next  | padding |
                        ------------------------------------------------------------
                        1st 4 byte    2nd 4 byte      3rd 4 byte          last 4 byte
  You should see that addr + 0x8 is the address of the pointer in the node, if addr
  is the address of the begining of the node.

  // smallest to largest: 2 1 6 5 4 3
  // largets to smallest: 3 4 5 6 1 2
  // Input should be: 4 3 2 1 6 5. 
  // Because 4 3 2 1 6 5 => 3 4 5 6 1 2 and then the stack becomes
  --------------
  | 0x6032f0   |
  --------------
  | 0x603300   |
  ...
  // Before entering <+183>, if input is 6 5 4 3 2 1:
  (gdb) x/6g $rsp+0x20
  // Note that here you should use "x/g" to specify the size, because at <+143> where the 
  // address of nodes is moved to the stack, 64-bit moving occurs.
  0x7ffffffede90: 0x00000000006032d0      0x00000000006032e0
  0x7ffffffedea0: 0x00000000006032f0      0x0000000000603300
  0x7ffffffedeb0: 0x0000000000603310      0x0000000000603320
                                                              // %rsp + 0x20 is the address of some memory on the stack
  0x00000000004011ab <+183>:   mov    0x20(%rsp),%rbx         // %rbx = (%rsp + 0x20), 64-bit copying
  ...
  0x00000000004011c8 <+212>:   cmp    %rsi,%rax               // compute %rax - %rsi
  0x00000000004011cb <+215>:   je     0x4011d2 <phase_6+222>  // If %rax == %rsi, goto <+222>, 
                                                              // This is the exiting condition: when each block has been proceed
  0x00000000004011cd <+217>:   mov    %rdx,%rcx               // Enter next iteration: go to next address
  0x00000000004011d0 <+220>:   jmp    0x4011bd <phase_6+201>
  // You should pay attention to the execution before exiting the loop, as %rdx, %rax and %rbx are used at next snippet.
  // The exiting condition is %rax == %rsi, so %rsi is the ending value of %rax.
  // Before exiting, %rdx is modified at <+201>. So %rdx has ending value of (%rsp + 0x48).
  // %rbx is not changed thoughout the loop, its value remains (%rsp + 0x20), the first address.
  // Here:
              <- %rax 
  -----------
  | addr6   |
  ...
  0x00000000004011d2 <+222>:   movq   $0x0,0x8(%rdx)          // 0x8(%rdx) = 0x8 + addr6 = the address of the pointer in the node
                                                              // Set it to be 0, as this should be the last node in the modified list
  0x00000000004011da <+230>:   mov    $0x5,%ebp               // %rbp = 5

  0x00000000004011df <+235>:   mov    0x8(%rbx),%rax          // %rax = (%rbx + 0x8) = the pointer of node stored at addr1
  0x00000000004011e3 <+239>:   mov    (%rax),%eax             // %eax = (%rax), %eax is the first 32-bit of the node pointed by node at addr1
  0x00000000004011e5 <+241>:   cmp    %eax,(%rbx)             // compute (%rbx) - %rax, i.e., first 32-bit of the node at addr1 - first 32-bit of the node pointed by node at addr1
  0x00000000004011e7 <+243>:   jge    0x4011ee <phase_6+250>  // If (%rbx) >= %rax, goto <+250>. 
                                                              // You need to make sure this is true.
                                                              // meaning that the values in the node are in reverse order
  0x00000000004011e9 <+245>:   callq  0x40143a <explode_bomb>
  0x00000000004011ee <+250>:   mov    0x8(%rbx),%rbx          // %rbx = (%rbx + 0x8)
  0x00000000004011f2 <+254>:   sub    $0x1,%ebp               // %rbp -= 1
  0x00000000004011f5 <+257>:   jne    0x4011df <phase_6+235>  // If %rbp != 1, goto <+235>, Another loop.
...
0000000000401338 <strings_not_equal>:
  // Pushing register values to stack
  401338:	41 54                	push   %r12
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx

  // Move 1st argument into %rbx, 2nd argument into %rbp
  40133c:	48 89 fb             	mov    %rdi,%rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp

  // Call string_length, arguments are not changed
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>

  // Store the result from previous call into %r12d, the lower 32-bits of %r12
  401347:	41 89 c4             	mov    %eax,%r12d

  // %rbp originally stores the 2nd argument(line 40133f), now stores %rbp into
  // %rdi, as the 1st argument into next function call
  40134a:	48 89 ef             	mov    %rbp,%rdi

  // Guessing: string_length only uses the 1st argument. 
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>

  // Make the value in %rdx to be 1, %rdx is the 3rd argument in function call
  401352:	ba 01 00 00 00       	mov    $0x1,%edx

  // Compare the result of 2 string_length call
  // %r12d - %eax, (length of argument 1) - (length of argument 2)
  401357:	41 39 c4             	cmp    %eax,%r12d

  // If not equal, jump to "mov    %edx,%eax"
...
000000000040145c <read_six_numbers>:   
                                                                // %rsi points to original stack top
  // Allocate 3 new bytes on stack.
  40145c:	48 83 ec 18          	sub    $0x18,%rsp           // %rsp -= 3 bytes

  // Copy the 2nd argument to 3rd arugment
  // 2nd argument(%rsi) originally contains the pointer to the top of the stack
  401460:	48 89 f2             	mov    %rsi,%rdx            // %rdx = %rsi  

  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx       // %rcx = %rsi + 0.5 byte
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax      // %rax = %rsi + 2.5 bytes
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)       // (%rsp + 1 byte) = %rax
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax      // %rax = %rsi + 2 bytes
  401474:	48 89 04 24          	mov    %rax,(%rsp)          // (%rsp) = %rax
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9        // %r9 = %rsi + 1.5 bytes
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8        // %r8 = %rsi + 1 byte

  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi       

  // At address 0x4025c3, stores the string literal "%d %d %d %d %d %d".
  // Thus, $rsi is a pointer to the first char in the literal, used as the 2nd argument in sscanf
  // The 1st arugment in the input line, previously stored in %rdi
  401485:	b8 00 00 00 00       	mov    $0x0,%eax

  // Before the above line, %r8 and %eax  refers to the same address on the stack,
  // or the pointer to the same byte.
  // The code "mov    $0x0,%eax" modifies the value stored at %eax, not anything else.
  // It does not modify the byte pointed to by the pointer, nor does it modify
  // the pointer stored at %r8.

  // The most important to keep in mind is that:
  // 1. When you are refering to a register, you are always referring to the value
  // it stores, as a register does not have any address.
  // 2. When register stores address/pointer, make sure you know whether you are
  // using the address, or dereferencing it: normally when you use addressing mode 
  // like 0x8(%rdx) or parenthesis like (%r8), you are dereferencing the pointer
  // stored in the register, except for LEA. When you refering to the register 
  // directly without parenthesis, you are using the content stored in the 
  // register, which is the address/pointer.  

  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  // The return value is the number of arugments successfully filled. 
  // The explode_bomb is passed if and only if there are at least 6 numbers filled.
