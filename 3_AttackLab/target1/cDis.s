...
00000000004017a8 <getbuf>:
  4017a8:	48 83 ec 28          	sub    $0x28,%rsp     // 40 bytes are allocated, 5 quadword
  4017ac:	48 89 e7             	mov    %rsp,%rdi      // %rdi = %rsp
  4017af:	e8 8c 02 00 00       	callq  401a40 <Gets>  // Calling get
  4017b4:	b8 01 00 00 00       	mov    $0x1,%eax      // %rax = 1
  4017b9:	48 83 c4 28          	add    $0x28,%rsp     // Deallocate the 5 quadword
  4017bd:	c3                   	retq                  // Return
  4017be:	90                   	nop                   // no op
  4017bf:	90                   	nop                   // no op
